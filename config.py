...
MPESA_SANDBOX_TEST_MSISDN = "258852411827"
...
settings.MPESA_SANDBOX_TEST_MSISDN = os.getenv(
    "MPESA_SANDBOX_TEST_MSISDN",
    MPESA_SANDBOX_TEST_MSISDN,
)
...
# Fluxo real M-Pesa: INS-0 (HTTP 200) só envia o pedido de PIN — não credita
settings.AUTO_CONFIRM_MPESA_DEPOSITS = _env_bool("AUTO_CONFIRM_MPESA_DEPOSITS", False)
settings.MPESA_AUTO_CREDIT_ON_ACCEPT = _env_bool("MPESA_AUTO_CREDIT_ON_ACCEPT", False)
